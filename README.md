...
This project measures the temperature and humidity using a DHT11 sensor and displays the results on a 16x2 LCD screen. By recreating the project it's possible to measure the temperature and humidity in a desired environment. 
